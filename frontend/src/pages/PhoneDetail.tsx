                        ...
                        <div className="space-y-3">
                          {phone.screenConditions.map((condition) => (
                            <div
                              ...
                              className={`flex items-start gap-3 border-2 rounded-2xl p-4 cursor-pointer hover:bg-white/80 bg-white/60 backdrop-blur transition-all select-none ${selectedScreenCondition === condition.id
                                  ? "border-blue-600 bg-blue-50"
                                  : "border-transparent"
                                }`}
                            >
                              <div
                                className={`w-6 h-6 rounded-full border-2 flex items-center justify-center mt-0.5 flex-shrink-0 ${selectedScreenCondition === condition.id
                                    ? "border-blue-600 bg-blue-600"
                                    : "border-gray-300"
                                  }`}
                              >
                      ...
                      <div>
                        ...
                        <div className="grid grid-cols-2 gap-3">
                          <div
                            ...
                            className={`flex items-center justify-center gap-2 border-2 rounded-2xl p-4 cursor-pointer hover:bg-white/80 bg-white/60 backdrop-blur transition-all select-none ${deviceTurnsOn === "yes"
                          ...
                          <div
                            ...
                            className={`flex items-center justify-center gap-2 border-2 rounded-2xl p-4 cursor-pointer hover:bg-white/80 bg-white/60 backdrop-blur transition-all select-none ${deviceTurnsOn === "no"
                      ...
                      <div>
                        ...
                        <div className="grid grid-cols-2 gap-3">
                          <div
                            ...
                            className={`flex items-center justify-center gap-2 border-2 rounded-2xl p-4 cursor-pointer hover:bg-white/80 bg-white/60 backdrop-blur transition-all select-none ${hasOriginalBox === "yes"
                                ? "border-green-600 bg-green-50"
                                : "border-transparent"
                              }`}
                          >
                          ...
                          <div
                            ...
                            className={`flex items-center justify-center gap-2 border-2 rounded-2xl p-4 cursor-pointer hover:bg-white/80 bg-white/60 backdrop-blur transition-all select-none ${hasOriginalBox === "no"
                      ...
                      <div>
                        ...
                        <div className="grid grid-cols-2 gap-3">
                          <div
                            ...
                            className={`flex items-center justify-center gap-2 border-2 rounded-2xl p-4 cursor-pointer hover:bg-white/80 bg-white/60 backdrop-blur transition-all select-none ${hasOriginalBill === "yes"
                                ? "border-green-600 bg-green-50"
                                : "border-transparent"
                              }`}
                          >
                          ...
                          <div
                            ...
                            className={`flex items-center justify-center gap-2 border-2 rounded-2xl p-4 cursor-pointer hover:bg-white/80 bg-white/60 backdrop-blur transition-all select-none ${hasOriginalBill === "no"
                                ? "border-gray-600 bg-gray-50"
                                : "border-transparent"
                              }`}
                          >
                        ...
                        <div className="space-y-3">
                          {[
                            ...
                            <div
                              ...
                              className={`flex items-start gap-3 border-2 rounded-2xl p-4 cursor-pointer hover:bg-white/80 bg-white/60 backdrop-blur transition-all select-none ${deviceAge === option.id
                                  ? "border-blue-600 bg-blue-50"
                                  : "border-transparent"
                                }`}
                            >
                              <div
                                className={`w-6 h-6 rounded-full border-2 flex items-center justify-center mt-0.5 flex-shrink-0 ${deviceAge === option.id
                                    ? "border-blue-600 bg-blue-600"
                                    : "border-gray-300"
                                  }`}
                              >
