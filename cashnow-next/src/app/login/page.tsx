...
export default function CustomerLogin() {
  ...
  const { login, loginWithToken, signup } = useAuth();
  ...
  */
  ...
  const submitGoogleProfile = async () => {
    ...
    try {
      ...
      const stateRedirect = (window.history.state as any)?.redirectTo;
        ...
        callback: async (resp: any) => {
          ...
          try {
            ...
            if (needs_profile) {
              ...
              const stateRedirect = (pathname as any)?.redirectTo;
              const savedRedirect = localStorage.getItem("postLoginRedirect");
              const target = stateRedirect || savedRedirect;
              if (target) {
                localStorage.removeItem("postLoginRedirect");
          ...
          <div className="flex flex-col items-center justify-center h-full p-4 lg:p-12 bg-white">
            <div className="w-full max-w-md">
              ...
              <div className="bg-white rounded-3xl p-8 mt-8 border border-gray-200">
                ...
                <h2 className="text-[32px] font-bold text-center text-slate-900 mb-4">
                  {isSignup ? "Create Account" : "Welcome Back"}
                </h2>

                <p className="text-center text-gray-500 text-[18px] mb-8">
