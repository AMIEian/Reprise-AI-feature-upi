...
export function Header() {
  ...
  const authPresent = isLoggedIn || (hasToken && Boolean(user || fetchedUser));
  ...
  const showMyOrders =
    ...
    !pathname.startsWith("/sell-phone");
            ...
            <div className="flex items-center gap-3">
              ...
              {authPresent ? (
                <>
                  ...
                  {user?.role === "agent" && (
                    <Link href="/agent/dashboard" className="hidden md:block">
                      <Button
                        variant="ghost"
